...
// modal scroll active and inactive
const mainSection = document.querySelector("main");
const enableButtons = document.querySelector("enable-button");

//   document.getElementsByClassName("enable-button").addEventListener("click", openModal);
 enableButtons.forEach(nw => nw.addEventListener("click", openModal));

function openModal() {
    mainSection.classList.toggle("block-scroll");
}

const ne = document.querySelector(".close-modal");
ne.forEach(n => n.addEventListener("click", closeModal));

function closeModal() {
    mainSection.classList.remove("block-scroll");
}